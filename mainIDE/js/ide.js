...
$(document).ready(function () {
    ...
    console.log("Hey, welcome to avakash IDE");
    ...
    $("body").keydown(function (e) {
        ...
        if (keyCode == 120) { // F9
            ...
            e.preventDefault();
            var url = prompt("Enter URL:", apiUrl);
            if (url != null) {
                url = url.trim();
            }
            if (url != null && url != "") {
...
public class Hello {\n\
    public static void Main() {\n\
        System.Console.WriteLine(\"Welcome to Avakash IDE\");\n\
    }\n\
}\n\
";
...
\n\
int main() {\n\
    std::cout << \"Welcome to Avakash IDE\" << std::endl;\n\
    return 0;\n\
}\n\
";
